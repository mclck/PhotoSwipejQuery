(function e(t, n, r) {
  ...
  * Copyright (c) 2017 Dmitry Semenov; */
    ...
    */
	...
	}, { "../helpers/photoswipe-ui-default": 7, "./photoswipetemplate": 5, "jquery": 1, "photoswipe": 2 }], 4: [function (require, module, exports) {
		'use strict';
			...
			class PhotoSwipeFromDOM extends PhotoSwipe {
				...
				makeThumbNails() {
					...
					$.each(this.items, (index, item) => {
						...
						let $thumb = $(`<a href="javascript:void(0)" class="pswp__thumb" data-pswp-thumb-index="${index}">
                        <img src="${item.thumb}"/>
                    </a>`);
	...
	}, { "../helpers/photoswipe-ui-default": 7, "./photoswipe": 3, "./photoswipetemplate": 5 }], 5: [function (require, module, exports) {
	...
	}, { "./components/photoswipefromdom": 4 }], 7: [function (require, module, exports) {
		/**
   *
